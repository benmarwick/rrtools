...
- this gives MIT license in DESCRIPTION, adds LICENSE file with our name in it
...
- we found that this function can be a little unreliable in RStudio, sometimes giving and erros and not fully enabling git in RStudio, to work around this:
...
- this also renders thr Rmd to and renders it to README.md, ready to display on GitHub
- this also adds a code of conduct to the compendium, to guide other contributors
