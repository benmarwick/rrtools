...
The goal of rrtools is to provide a basic compendium suitable for doing reproducible research with R. This package documents the key steps of creating a new research compendium in an efficient order suitable for reuse in new projects, as well as providing functions to quickly create a new compendia.  

It provides a template for writing in literate programming enviroment using R Markdown and bookdown, isolation of the computational enviroment using Docker, and continous integration using Travis. It provides a convienent starting point for writing a journal article, report or thesis. 
...
#### 6. create `analysis/` directory, and `paper.Rmd` and `analysis/data/` directory

- in metadata yml block    
    + output: bookdown::word_document2  or html_ or pdf_     
...
- write `analysis/` dir and `paper.Rmd`
