...
This function combines the key parts of the first five steps described below, using sensible, widely-used defaults. It gives detailed console output to guide you on the next steps to take with your compendium (it will not create a GitHub repository, or do the Travis and Docker steps detailed below).
...
- we need to:
    + install and configure git _before_ running this line. See [Happy Git With R](http://happygitwithr.com) for details on how to do this. 
