...
```{r eval = FALSE}
create_compendium("pkgname", "Your Name")
```

This function combines the first five steps described below, using sensible, widely-used defaults. It gives detailed console output to guide you on the next steps to take with your compendium.
